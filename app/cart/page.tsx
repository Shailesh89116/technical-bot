...
import { Minus, Plus, X, ArrowLeft, ShieldCheck, Truck, Award, Clock } from "lucide-react"
  ...
  const [cartItems, setCartItems] = useState<CartItem[]>([
    {
      ...
      code: "GR-001",
      category: "grand",
      specs: "10mm thickness, 1380 x 3000 mm",
      image: "/img-1.png",
      price: 4200,
      quantity: 1,
      selectedSize: "1380 x 3000 mm",
      thickness: "10 mm",
      uvCut: "99.4%",
    },
    {
      ...
      code: "PR-562",
      category: "prime",
      specs: "6mm thickness, 1380 x 3000 mm",
      image: "/img-2.png",
      price: 2800,
      quantity: 2,
      selectedSize: "1380 x 3000 mm",
    ...
    <div className="min-h-screen bg-gray-50 pt-20">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Your Cart</h1>
          <p className="mt-2 text-gray-600">Review your selected acrylic sheets before checkout</p>
        </div>
        ...
        {cartItems.length === 0 ? (
          <div className="rounded-2xl border border-gray-200 bg-white p-12 text-center shadow-sm">
            ...
            <h2 className="mb-4 text-xl font-semibold text-gray-900">Your cart is empty</h2>
            <p className="mb-8 text-gray-600 max-w-md mx-auto">
              Discover our premium acrylic sheets for your construction and design projects.
            </p>
            <Button asChild className="rounded-full bg-black px-8 py-3 hover:bg-gray-800">
              ...
              <div className="rounded-2xl border border-gray-200 bg-white shadow-sm">
                    ...
                    {cartItems.map((item) => (
                      ...
                      >
                        ...
                        <div className="h-24 w-24 sm:h-28 sm:w-28 flex-shrink-0 overflow-hidden rounded-xl border border-gray-200">
                          <Image
                            src={item.image || "/placeholder.svg?height=112&width=112&query=acrylic sheet"}
                            alt={item.name}
                            width={112}
                            height={112}
                        ...
                        <div className="flex flex-1 flex-col">
                          <div className="flex flex-col sm:flex-row sm:justify-between gap-2">
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-gray-600 mb-1">Code: {item.code}</p>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between border-t border-gray-100 p-6 sm:p-8 gap-4">
                  ...
                  <div className="text-sm text-gray-600">
                    Subtotal: <span className="font-semibold text-gray-900">₹{subtotal.toLocaleString()}</span>
                  </div>
                </div>
              </div>
                  ...
                  <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                          Most orders ship within 2-3 business days across India.
                        </p>
                      </div>
                    </div>
                  </div>
